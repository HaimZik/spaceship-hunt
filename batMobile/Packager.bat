...
echo.
echo Android: 
echo - generate a default certificate using 'batMobile\CreateCertificate.bat'
echo   or configure a specific certificate in 'batMobile\SetupApp.bat'.
echo.
echo iOS: 
echo - configure your developer key and project's Provisioning Profile
echo   in 'batMobile\SetupApp.bat'.
echo.
